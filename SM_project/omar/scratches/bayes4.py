...
def train_model(x_train, y_train, n_epoch=500, std=0.1):
...
def main():
    ...
    usefulness_train = (dummy_rmse - train_rmse) / dummy_rmse
    ...
    print()
    print(f'  train_useful = {usefulness_train:6.1%}')
    print(f'   test_useful = {usefulness_test:6.1%}')

    # save model
    path = f'model_par.pkl'
